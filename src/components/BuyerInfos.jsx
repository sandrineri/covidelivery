        ...
        <React.Fragment>
            ...
            <form className="form buyer-infos-form">
                <div className="form-part form-part1">
                    ...
                    <input className="form-input" type="text" name="nom" defaultValue={buyerInfos.name} placeholder="Jean Dupont..." id="name" disabled={disabled} required onChange={(input) => changeInfo('name', input.target.value)} />
                </div>
                <div className="form-part form-part2">
                    <label htmlFor="phone">Votre numéro de téléphone<span className="required-sign">*</span>&nbsp;:</label>
                    <input className="form-input" type="tel" name="phone" pattern="[0-9]{2} [0-9]{2} [0-9]{2} [0-9]{2} [0-9]{2}..." defaultValue={buyerInfos.phone} placeholder="06 00 00 00 00" id="phone" required onChange={(input) => changeInfo('phone', input.target.value)} />
                </div>
                <div className="form-part form-part3">
                    <label htmlFor="address">Votre adresse<span className="required-sign">*</span>&nbsp;:</label>
                    <input className="form-input" type="text" name="address" defaultValue={buyerInfos.address} placeholder="1250, allée Edward Whittemore, 75012 Paris..." id="address" required onChange={(input) => changeInfo('address', input.target.value)} />
                </div>
                <div className="form-part form-part4">
                    <label htmlFor="mail">Votre adresse e-mail<span className="required-sign">*</span>&nbsp;:</label>
                    <input className="form-input" type="email" name="mail" defaultValue={buyerInfos.email} placeholder="jeandupont@monmail.com..." id="mail" required onChange={(input) => changeInfo('email', input.target.value)} />
                </div>
                <div className="form-part form-part5">
                    <label htmlFor="extra">Informations complémentaires&nbsp;:</label>
                    <input className="form-input" type="text" name="extra" defaultValue={buyerInfos.extra} placeholder="Digicode: 0000..." id="extra" required onChange={(input) => changeInfo('extra', input.target.value)} />
                </div>
